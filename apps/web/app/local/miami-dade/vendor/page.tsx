...
const agency = getLocalAgencyRegistration("miami-dade");

export default function MiamiDadeVendorPage() {
  if (!agency) return null;

  return (
    <LocalJourneyLayout
      journeyTitle="Miami-Dade County Journey"
      title="Mirror the Miami-Dade County vendor registration first."
    ...
    >
        <section className="rounded-[30px] border border-slate-600/20 bg-[linear-gradient(180deg,_rgba(14,24,36,0.98)_0%,_rgba(13,22,33,0.98)_58%,_rgba(10,17,26,0.98)_100%)] p-8 shadow-[0_16px_48px_rgba(0,0,0,0.28)] md:p-10">
          ...
          <p className="mt-5 max-w-4xl text-lg leading-8 text-slate-200">
            This step is the county supplier front door. It helps the business get
            the vendor profile, tax information, contact details, and reusable documents
            lined up before moving into Miami-Dade SBE or DBE decisions.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            >
              Open Official Miami-Dade Registration
            </a>
            {agency.paymentUrl ? (
              <a
                href={agency.paymentUrl}
                target="_blank"
                rel="noreferrer"
                className="rounded-2xl border border-emerald-300/30 bg-emerald-300/10 px-6 py-4 text-sm font-bold text-emerald-100 transition hover:bg-emerald-300/15"
              >
                Open Vendor Payments / Verification
              </a>
            ) : null}
            <Link
              href="/local"
        ...
        <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-6">
            ...
            <div className="rounded-[28px] border border-yellow-500/20 bg-[linear-gradient(180deg,_rgba(33,24,12,0.45)_0%,_rgba(18,14,10,0.9)_100%)] p-6 shadow-[0_14px_44px_rgba(0,0,0,0.24)]">
              ...
              <h2 className="mt-3 text-3xl font-bold text-white">
                Answer these before opening the county system
              </h2>
              <p className="mt-3 text-sm leading-7 text-zinc-200">
                This is the CHUB mirror. It prepares the same kind of information
                the county vendor setup is likely to ask for, but in plain English first.
              </p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[28px] border border-slate-700/30 bg-[linear-gradient(180deg,_rgba(12,18,27,0.98)_0%,_rgba(10,14,21,0.98)_100%)] p-6 shadow-[0_14px_44px_rgba(0,0,0,0.24)]">
              ...
              {agency.paymentUrl && agency.paymentLabel ? (
                <p className="mt-3 text-sm leading-7 text-zinc-300">
                  County vendor payments / verification:{" "}
                  <a href={agency.paymentUrl} target="_blank" rel="noreferrer" className="text-cyan-200 underline underline-offset-4">
                    {agency.paymentLabel}
                  </a>
                </p>
              ) : null}
